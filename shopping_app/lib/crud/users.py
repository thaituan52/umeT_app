...
# your_project/crud/users.py
from sqlalchemy.orm import Session
from datetime import datetime, timezone
from typing import Optional

from ..models import User # Relative import from models.py
from ..schemas import UserCreate # Relative import from schemas.py
from ..utils.auth import hash_password # Relative import for password hashing
